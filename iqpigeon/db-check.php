...
try {
    ...
    if (str_contains($msg, '1045') || str_contains($msg, 'Access denied')) {
        ...
        echo '<li>Note the <strong>full</strong> database name (e.g. <code>iqpigeon_adb</code>) — not a short name.</li>';
        echo '<li>Note the <strong>full</strong> username (e.g. <code>iqpigeon_auser</code>) — must match exactly.</li>';
