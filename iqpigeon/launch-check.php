...
const EXPECTED_CONFIG_ID = '1668876371003395';
...
lc_add(
    ...
    'Set WEBHOOK_VERIFY_TOKEN (e.g. iqpigeon_webhook_2025) in config.local.php and Meta Dashboard'
);
...
lc_meta_manual(
    ...
    . $appUrl . '/api/whatsapp-webhook.php | Verify token: ' . ($verifyToken !== '' ? $verifyToken : 'iqpigeon_webhook_2025'),
    'critical'
);
lc_meta_manual(
