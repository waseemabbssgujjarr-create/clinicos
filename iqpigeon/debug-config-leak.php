...
$knownLeak = 'eanpGgeqevhhCpcieDEvAoeaEGPAhaXhHNvioejtCIXjGXJLBfOOdCmEFoDijMLX';
$fatalError = '';
...
<div class="wrap">
    ...
    echo dcl_status('Key in admin-nav.php file', !dcl_file_has_runtime_leak($adminNavRaw, $knownLeak), dcl_file_has_runtime_leak($adminNavRaw, $knownLeak) ? 'Bare key pasted in file — re-upload clean copy' : 'Not in file (stripper code ignored)');
    ...
    $navClean = !str_contains($navTestOut, $knownLeak);
    echo dcl_status('admin-nav runtime test', $navClean, $navClean ? 'No key in output' : 'KEY STILL OUTPUT — check OPcache or file on disk');
    ?>
