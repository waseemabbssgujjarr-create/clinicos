/**
 * WhatsApp hero chat — sequential message reveal with typing indicator, ~8s loop
 */
(function () {
  var chat = document.getElementById('waChatLoop');
  if (!chat) return;
  ...
  var sequence = [
    ...
    },
    {
      type: 'msg',
      dir: 'in',
      text: "Hi! I'd like to book a teeth cleaning this week 🦷",
      time: '9:41'
    },
    { type: 'typing' },
    {
      type: 'msg',
      dir: 'out',
      text: 'Hello! 👋 I have Wed 3pm or Thu 11am. Which works?',
      time: '9:41'
    },
    {
      type: 'msg',
      dir: 'in',
      text: 'Wednesday 3pm please',
      time: '9:42'
    },
    { type: 'typing' },
    {
      type: 'msg',
      dir: 'out',
      text: '✅ Booked! Wed 3pm — Teeth Cleaning. Reminder sent.',
      time: '9:42'
    }
  ];
  ...
  function createMsg(dir, text, time) {
    var el = document.createElement('div');
    el.className = 'wa-msg wa-msg-' + dir;
    el.innerHTML =
  ...
  async function runSequence() {
    ...
    for (var i = 0; i < sequence.length; i++) {
      ...
      if (step.type === 'voice') {
        ...
        show(createMsg(step.dir, step.text, step.time));
